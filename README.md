...
Features:
PaprAI - The Comprehensive Study Platform

Automatic downloading of papers by subject/year/variant OR random paper
(In the future: integrate with real past papers and questions from them)
Sidebar: 
...
Other sidebar: AI Helper Panel to guide through questions and give hints/help
(in the future: use OCR to mark the working out to check where mistake is)
